...
.then(data => {
	...
	$("#main_6, #main_7, #main_8, #main_9, #main_10, #main_11, #main_12, #is2, #is3, #dm, #wd, #ut, #sn, #gt, #hosf, #cb, #tw, #ggc, #mn, #mb, #wr, #od, #dh, #nl, #bi, #iw, #ga, #le, #dv, #ic, #is, #fc, #wb, #cf").click(function() {
